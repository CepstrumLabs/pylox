...
class Assign(Expr):
	...
	def __hash__(self):
		return hash((self.assign_to,self.to_assign,))
...
class Call(Expr):
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.callee==other.callee and self.arguments==other.arguments

	def __hash__(self):
		return hash((self.callee,self.arguments,))
