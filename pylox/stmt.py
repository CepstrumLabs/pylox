...
class Var(Stmt):
	...
	def __hash__(self):
		return hash((self.name,self.initialiser,))
...
class While(Stmt):
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.condition==other.condition and self.statement==other.statement

	def __hash__(self):
		return hash((self.condition,self.statement,))
...
class Function(Stmt):
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.name==other.name and self.body==other.body and self.params==other.params

	def __hash__(self):
		return hash((self.name,self.body,self.params,))
...
class Return(Stmt):
	...
	def __eq__(self, other):
		return isinstance(other, self.__class__) and self.keyword==other.keyword and self.value==other.value

	def __hash__(self):
		return hash((self.keyword,self.value,))
